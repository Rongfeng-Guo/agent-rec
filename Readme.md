...
`cdpo_dataset_manifest.json`, `llamafactory_dataset_info_snippet.json`, summary
CSV/JSON, method-level aggregates, and a LaTeX table. The branch metrics should be described as a controlled
