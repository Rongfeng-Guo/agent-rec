...
class RLHFArguments:
    ...
    pref_loss: Literal["sigmoid", "hinge", "ipo", "kto_pair", "orpo", "simpo", "adpo"] = field(
        default="sigmoid",
        metadata={"help": "The type of DPO loss to use."},
    )
    adpo_kl_type: Literal["l2", "abs"] = field(
        default="abs",
        metadata={"help": "The type of action-level KL divergence used in ADPO loss."}
    )
    adpo_kl_weight: float = field(
        default=1.0,
        metadata={"help": "The coefficient for action-level KL divergence in ADPO loss."}
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    def __post_init__(self):
        ...
        self.use_ref_model = self.stage in ["dpo", "adpo"] and self.pref_loss not in ["orpo", "simpo"]
