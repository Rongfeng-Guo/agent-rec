...
# 第一个输出目录
OUTPUT_DIR="/home/u2023000157/ecpo/fine-tuning/sto_adpo_v1_ab_eval/Book/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}_sft${SFT_BETA}_adpo_kl${ADPO_KL_WEIGHT}"
...
nohup llamafactory-cli train \
  ...
  --lora_target all \
  --dataset book_sto_dpo_v1_ab_eval \
  --template llama3 \
  --cutoff_len 2048 \
