...
OUTPUT_DIR="/data/fengxueyang/ecpo/fine-tuning/bpo_adpo_v3/Yelp/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}"
...
nohup llamafactory-cli train \
  ...
  --ref_model /data/fengxueyang/.cache/modelscope/hub/LLM-Research/Meta-Llama-3.1-8B-Instruct \
  --ref_model_adapters /data/fengxueyang/ecpo/fine-tuning/sft/Yelp/lr5.0e-5_epochs3.0 \
  --stage dpo \
  --do_train true \
  --pref_loss adpo \
  --adpo_kl_type abs \
