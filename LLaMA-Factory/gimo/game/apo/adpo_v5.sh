...
NUM_EPOCHS=3.0
SFT_BETA=0
ADPO_KL_WEIGHT=0.000001
# Define the output directory dynamically based on learning rate and num_epochs
OUTPUT_DIR="/data/fengxueyang/ecpo/fine-tuning/bpo_adpo_v5/Game/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}_sft${SFT_BETA}_adpo_kl${ADPO_KL_WEIGHT}"
