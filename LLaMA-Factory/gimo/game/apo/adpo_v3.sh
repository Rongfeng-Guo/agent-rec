...
OUTPUT_DIR="/data/fengxueyang/ecpo/fine-tuning/bpo_adpo_v3/Book/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}"
...
nohup llamafactory-cli train \
  ...
  --adapter_name_or_path /data/fengxueyang/ecpo/fine-tuning/sft/Book/lr5.0e-5_epochs3.0\
  --stage dpo \
  --do_train true \
  --pref_loss adpo \
  --adpo_kl_type abs \
