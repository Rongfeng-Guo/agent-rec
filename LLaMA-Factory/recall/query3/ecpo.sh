...
OUTPUT_DIR="/data/fengxueyang/ecpo/recall_exp/fine-tuning/query3/ecpo/Book/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}"
...
nohup llamafactory-cli train \
  ...
  --adapter_name_or_path /data/fengxueyang/ecpo/recall_exp/fine-tuning/query3/sft/Book/lr5.0e-5_epochs3.0\
  --stage dpo \
  --do_train true \
  --finetuning_type lora \
  --lora_target all \
  --dataset amazon_book_ecpo_query3 \
  --template llama3 \
  --cutoff_len 2048 \
